...
public class RSGetAllToplicList extends StringRS {
	private String community_id;
	private String page;
	private String size;
	private String type;

	public RSGetAllToplicList(String community_id, String page, String size,
			String type) {
	...
	public String getCustomUrl() {
		return RemoteConst.URL_TOPIC_INSERT;
	}
