...
public abstract class Model_TrendsBase extends MultiModelBase {
	...
	public static enum SpanType implements Serializable {
		TEXT(0x1), TOPIC(0x2), AT(0x3), EMOTION(0x4), NAME(0x5), COMMUNITY(0x6), URL(0x7), TICKET(
				0x8);
		private int value;
	...
	public static enum TrendsType implements Serializable {
		...
		MSG("xiaoxi"), FOOD("meishi"), ENTIRMENT("yule"), SHOP("gouwu"), BEAUTY("meirong"), MARRAGE(
				"hunqing"), CHILDREN("qinzi"), GYM("yundong"), HOTEL("jiudian"), LIFE("jiazheng"), JOIN(
				"jiaxiaoqu"), FOLLOW("guanzhu"), DIAL("dianhua"), COMMENT("pingjia"), QUIT("tuichu"), JION_LC(
				"jiaquanzi"), CHANG_HEADER("touxiang"), CHANGE_SIGN("qianming"), FANGCHAN(
				"fangchan"), JIAJIAO("jiajiao"), NOTICE_COMM(0x12), NOTICE_AT(0x13), NOTICE_ATTEN(
