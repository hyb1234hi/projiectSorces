...
public class SlidingFragmentActivity extends FragmentActivity implements SlidingActivityBase {
	 ...
	 * added by sunny.dai
	 */
	public void addUnControledViews(View...views){
		mHelper.getSlidingMenu().addUncontrolViews(views);
	}
	
	/*
	 * added by sunny.dai
	 */
	public void removeUnControledViews(View...views){
		mHelper.getSlidingMenu().removeUncontrolViews(views);
	}
	...
	public void removeAllUncontrolViews(){
		mHelper.getSlidingMenu().removeAllUncontrolViews();
	}
}
