...
public class ExtendedListView extends ListView implements OnScrollListener {
	...
	private boolean isShowScrollBarPanel = true;
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
		...
		if (null != mPositionChangedListener && null != mScrollBarPanel) {
			...
			if (totalItemCount > 0) {
				...
				// System.out.println("[offSet : "+computeVerticalScrollOffset()+"]\t[extent : "+computeVerticalScrollExtent()+"]\t[range : "+computeVerticalScrollRange()+"]\n");
				/*
	...
	protected boolean awakenScrollBars(int startDelay, boolean invalidate) {
		final boolean isAnimationPlayed = super.awakenScrollBars(1500, invalidate);

		if (isAnimationPlayed == true && mScrollBarPanel != null && isShowScrollBarPanel) {
			...
			mHandler.postAtTime(mScrollBarPanelFadeRunnable,
					AnimationUtils.currentAnimationTimeMillis() + 1500);
		}
	...
	public void setShowScrollBarPanel(boolean isShowScrollBarPanel) {
		this.isShowScrollBarPanel = isShowScrollBarPanel;
	}
