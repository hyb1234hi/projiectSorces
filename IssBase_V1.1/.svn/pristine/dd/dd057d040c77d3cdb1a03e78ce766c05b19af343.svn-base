...
public class ImageLoader {
	...
	public static ImageLoader getInstance(Activity mContext) {
	...
	protected ImageLoader(Activity mContext) {
		ImageLoader.mContext = mContext;
	}
	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener) {
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				...
				//added by sunny
				listener.onBitmapCreate(false, bmp);
				//added end				
			...
			//added by sunny
			listener.onBitmapCreate(true, null);
			//added end				
			...
			LoadAndDisplayImageTask displayTask = new LoadAndDisplayImageTask(mContext, engine, imageLoadingInfo, options.getHandler());
			engine.submit(displayTask);
		}
	}
