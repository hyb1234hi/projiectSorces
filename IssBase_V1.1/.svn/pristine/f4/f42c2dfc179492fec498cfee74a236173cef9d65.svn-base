 ...
 * options} for
 * {@link ImageLoader#loadImage(String, int, int, com.iss.imageloader.core.DisplayImageOptions, com.nostra13.universalimageloader.core.assist.ImageLoadingListener)
