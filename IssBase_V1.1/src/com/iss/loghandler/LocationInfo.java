...
//      if (PhoneInfo.checkPermission(this.mContext, "android.permission.ACCESS_FINE_LOCATION"))
//      {
          Log.i(TAG, "android.permission.ACCESS_FINE_LOCATION-");
        localLocation = this.mLocationManager.getLastKnownLocation("gps");
        if (localLocation != null)
        {
          Log.i(TAG, "get location from gps:" + localLocation.getLatitude() + "," + localLocation.getLongitude());
          return localLocation;
        }
//      }
//      if (PhoneInfo.checkPermission(this.mContext, "android.permission.ACCESS_COARSE_LOCATION"))
//      {
          Log.i(TAG, "android.permission.ACCESS_COARSE_LOCATION-");
        localLocation = this.mLocationManager.getLastKnownLocation("network");
        if (localLocation != null)
        {
          Log.i(TAG, "get location from network:" + localLocation.getLatitude() + "," + localLocation.getLongitude());
          return localLocation;
        }
//      }
